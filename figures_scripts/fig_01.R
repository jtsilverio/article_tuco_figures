...
library(scales)
library(showtext)
source("figures_scripts/function_actogram.R")
...
ggsave(filename = "images/fig_01_autumn.jpeg",
...
ggsave(filename = "images/fig_01_winter.jpeg",
...
ggsave(filename = "images/fig_01_spring.jpeg",
...
ggsave(filename = "images/fig_01_summer.jpeg",
