...
# 03: Rhithmicity Plot
acf_peaks = readRDS("rhythmicity/rhythmicity_classified.rds") %>% ungroup()
period_peaks = readRDS("periodogram/peaks_period.rds") %>% ungroup()
...
rhythmicity_plot = acf_dist_plot + period_dist_plot + patchwork::plot_layout(widths = c(2,1))
...
ggsave(filename = "images/fig_05.jpeg",
       plot = fig_05,
       device = "jpeg",
       dpi = 132,
       width = 210,
