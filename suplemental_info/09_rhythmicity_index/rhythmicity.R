...
rhythmicity = readr::read_csv("suplemental_info/09_rhythmicity_index/visual_rhythmicity_analysis.csv", col_types = "ffl")
...
ggsave("suplemental_info/09_rhythmicity_index/acf_plot.png", 
...
ggsave("suplemental_info/09_rhythmicity_index/RI_distributions.png", 
       bx_plot, "png", bg = "white",
       dpi = 150, width = 900, height = 600, units = "px")
